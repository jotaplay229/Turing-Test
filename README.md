...
Ao atualizar uma versão existente, substitua os arquivos da raiz do repositório pelo conteúdo do novo pacote e faça o commit. O Netlify inicia outro build. Os imports internos usam caminhos relativos com `.js`/`.jsx`; preserve essas extensões e as letras maiúsculas/minúsculas dos nomes dos arquivos.
